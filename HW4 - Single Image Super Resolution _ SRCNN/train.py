...
# optimizer
optimizer = optim.Adam(model.parameters(), lr=opt.lr) #lr = learning rate
if checkpoint:
...
def train(epoch, data_loader):
    ...
    for data in tqdm(data_loader, ascii=True):   #tqdm is a progress bar
        ...
        loss_metric.add(loss.item()*len(input))
        #k = loss_metric.average(len(input))
        #print("k={}".format(k))
